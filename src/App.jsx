...
import{sb,CATS,NON_ALL_CATS,TABS,REACTIONS,DAILY_PROMPTS,PASS_PERKS,FREE_REACTIONS_PER_DAY,FREE_VOICE_LIMIT,PASS_VOICE_LIMIT,MAX_CHARS,FREE_AI_PER_DAY,COIN_COST_BOOST,COINS_PER_RANT,COINS_PER_HEAT_MILESTONE,fmt,ago,velocity,randBars,getDailyPrompt,isFlipTheVoidDay,todayStr,addCoins,spendCoins,incReactionCount,canReact,incAICount,canUseAI,aiRemaining}from"./constants.jsx";
// ─── AI VALIDATION ────────────────────────────────────────────────────────────
...
function CSS(){return(
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .streak-badge{display:flex;align-items:center;gap:10px;background:rgb
...
export{sb,CATS,NON_ALL_CATS,TABS,REACTIONS,FREE_VOICE_LIMIT,PASS_VOICE_LIMIT,MAX_CHARS,COIN_COST_BOOST,COINS_PER_RANT,COINS_PER_HEAT_MILESTONE,FREE_AI_PER_DAY,isFlipTheVoidDay,todayStr,normalizeRant,fetchRants,insertRant,toggleReaction,fetchFollowing,followUser,unfollowUser,fetchNotifications,pushNotification,updateProfile,boostRant,fetchSuggestedRanters,canReact,canUseAI,incReactionCount,addCoins,spendCoins,AuthScreen,ValidationScreen,RantCard,DailyPrompt,RantOfTheDay,SuggestedRanters,ComposeSheet,PassModal,BoostModal,ReportModal,ShareCard,TrendingScreen,NotificationsScreen,ProfileScreen,FollowingFeed,InlineSearch,CoinBadge,CSS};

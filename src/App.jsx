...
function PassModal({onClose,onActivate}){
  ...
  const CHECKOUT_URL="https://rantit.lemonsqueezy.com/checkout/buy/79ad2d7c-aee3-4bb2-ad3f-7d971b77c053";
  const go=async()=>{
    setProcessing(true);
    localStorage.setItem('pass_pending','1');
    window.location.href=CHECKOUT_URL+"?checkout[success_url]=https://rantit.app/?activated=true";
  };
  return(
    <div className="overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>

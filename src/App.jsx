...
// ─── PROFILE ─────────────────────────────────────────────────────────────────
// ─── USER PROFILE SCREEN ──────────────────────────────────────────────────────
function UserProfileScreen({username, currentUserId, followingIds, onFollow, onUnfollow, onClose, onTapUser, cardProps}){
...
export default function App(){
  ...
  if(viewingUser)return<><CSS/><UserProfileScreen username={viewingUser} currentUserId={authUser?.id} followingIds={followingIds} onFollow={handleFollow} onUnfollow={handleUnfollow} onClose={()=>setViewingUser(null)} cardProps={cardProps} onTapUser={setViewingUser}/></>;

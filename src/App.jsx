...
function ResetPasswordScreen(){
  ...
  if(done)return(
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"var(--bg)",flexDirection:"column",gap:16,padding:20}}>
      ...
      <button style={{background:"var(--accent)",border:"none",color:"#fff",fontFamily:"var(--display)",fontSize:14,letterSpacing:2,padding:"12px 24px",borderRadius:8,cursor:"pointer"}} onClick={()=>window.location.href="/"}>GO TO APP</button>
    </div>
  );
  return(
...
export default function App(){
  ...
  if(hashParams.get("type")==="recovery")return<><CSS/><ResetPasswordScreen/></>;
